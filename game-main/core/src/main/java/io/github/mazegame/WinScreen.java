...
public class WinScreen implements Screen {
    ...
    public void show() {
        ...
        leaderboardUpdated = leaderboard.addEntry(playerName, playerScore, playerTime, true);
    ...
    public void render(float delta) {
        ...
        MazeGame.font.draw(game.batch, "YOU WIN!", 250, 480);
        
        // Draw personal stats
        MazeGame.font.getData().setScale(1.2f);
        MazeGame.font.draw(game.batch, "YOUR STATS", 50, 440);
        ...
        for (int i = 0; i < topEntries.size(); i++) {
            ...
            MazeGame.font.draw(game.batch, rank + " " + name, 410, startY - (i * 25));
