...
/** An NPC entity that offers a quest to trade items with the player. Gives Code1 as a reward. */
public class QuestGiverEntity extends CharacterEntity {
     ...
     * @param code1 the Code object to reward on successful trade
     */
    public QuestGiverEntity(Vector2 gridPosition, Item wantedItem, Item heldItem, Code code1) {
        super(gridPosition);
